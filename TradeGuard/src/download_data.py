...
class DataFetcherTraining:
    def __init__(self, output_dir="TradeGuard/data", force=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="TradeGuard/data", help="Output directory")
    ...
    log_file = os.path.join(log_dir, f"download_data_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt")
    tee = Tee(log_file)
