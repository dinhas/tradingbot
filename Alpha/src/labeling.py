...
class Labeler:
    def __init__(self, tp_mult: float = 4.0, sl_mult: float = 2.0, ema_window: int = 100, max_bars: int = 24, adx_threshold: float = 25.0):
        """
        ...
        Args:
            ...
            max_bars: Vertical barrier (User: 24 candles).
