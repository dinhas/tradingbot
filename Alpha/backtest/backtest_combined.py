...
class CombinedBacktest:
    ...
    def __init__(self, alpha_model, risk_model, data_dir, initial_equity=initial_equity, alpha_norm_env=None, risk_norm_env=None, env=None, verify_alpha=False):
        ...
        if env is not None:
            ...
            self.env = TradingEnv(data_dir=data_dir, stage=1, is_training=False, trading_cost_pct=0.0)
    ...
    def build_risk_observation(self, asset, alpha_obs):
        ...
        # The Risk Model was trained on a dataset generated by 'generate_risk_dataset.py'.
        # That script applied Alpha's VecNormalize to the features BEFORE saving them.
        # So we must apply it here too, before passing to the Risk Model.
        ...
        # We use the NORMALIZED market obs here
        ...
        # Normalize if normalizer is available (This is the SECOND normalization, specific to Risk Model)
    ...
    def calculate_position_size(self, asset, entry_price, atr, sl_mult, tp_mult, risk_raw, direction):
        ...
        # Match RiskEnv logic exactly
        pip_scalar = 0.01 if 'JPY' in asset else 0.0001
        ...
        # Match training: Force MIN_LOTS, never block trades
...
def run_combined_backtest(args):
    ...
    shared_env = TradingEnv(data_dir=data_dir_path, stage=1, is_training=False, trading_cost_pct=0.0)
